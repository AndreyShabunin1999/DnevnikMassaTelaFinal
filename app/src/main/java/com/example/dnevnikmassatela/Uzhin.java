...
public class Uzhin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                AlertDialog.Builder builder = new AlertDialog.Builder(Uzhin.this);
                builder.setTitle("Важное сообщение!")
                        ...
                        .setPositiveButton("Да, удалить", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                db.delete("TABLE_UZHIN", "_id = ?", new String[]{String.valueOf(id)});
                            }
                        })
        ...
        Cursor w = db.rawQuery("select * from TABLE_UZHIN",null);
                ...
                while (Set == true) {
                    try {
                        runOnUiThread(new Runnable() {
                            ...
                            @Override
                            public void run() {
                                Cursor c = db.rawQuery("select * from TABLE_UZHIN",null);
                                if(kol != c.getCount()){
                                    Spisochek();
                                    setKol(c.getCount());
                                }
    ...
    public void Spisochek(){
        ...
        userCursor =  db.rawQuery("Select * from TABLE_UZHIN where data = date('now','localtime') AND uzh_user = " + id, null);
        // определяем, какие столбцы из курсора будут выводиться в ListView
        String[] headers = new String[] {DatabaseHelper.COLUMN_NAME_PROD,DatabaseHelper.COLUMN_KKAL};
        // создаем адаптер, передаем в него курсор
        userAdapter = new SimpleCursorAdapter(Uzhin.this, android.R.layout.two_line_list_item,
    ...
    public void onMyButtonClick(View view)
    {
        ...
        RequestQueue requestQueue =  Volley.newRequestQueue(Uzhin.this);
        Uzhin.Listener listener = new Uzhin.Listener();
    ...
    class Listener implements ResponseListener {
        ...
        ProductAdapter adapter = new ProductAdapter( Uzhin.this, R.layout.list_item, products, id, act);
