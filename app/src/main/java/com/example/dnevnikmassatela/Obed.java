...
public class Obed extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                AlertDialog.Builder builder = new AlertDialog.Builder(Obed.this);
                builder.setTitle("Важное сообщение!")
                        ...
                        .setPositiveButton("Да, удалить", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                db.delete("TABLE_DINNER", "_id = ?", new String[]{String.valueOf(id)});
                                //Spisochek();
                            }
                        })
        ...
        Cursor w = db.rawQuery("select * from TABLE_DINNER",null);
                ...
                while (Set == true) {
                    try {
                        runOnUiThread(new Runnable() {
                            ...
                            @Override
                            public void run() {
                                Cursor c = db.rawQuery("select * from TABLE_DINNER",null);
                                if(kol != c.getCount()){
                                    Spisochek();
                                    setKol(c.getCount());
                                }
    ...
    public void Spisochek(){
        ...
        userCursor =  db.rawQuery("Select * from TABLE_DINNER where data = date('now','localtime') AND din_user = " + id, null);
        // определяем, какие столбцы из курсора будут выводиться в ListView
        String[] headers = new String[] {DatabaseHelper.COLUMN_NAME_PROD,DatabaseHelper.COLUMN_KKAL};
        // создаем адаптер, передаем в него курсор
        userAdapter = new SimpleCursorAdapter(Obed.this, android.R.layout.two_line_list_item,
    ...
    public void onMyButtonClick(View view)
    {
        ...
        RequestQueue requestQueue =  Volley.newRequestQueue(Obed.this);
        Obed.Listener listener = new Obed.Listener();
    ...
    class Listener implements ResponseListener {
        ...
        ProductAdapter adapter = new ProductAdapter( Obed.this, R.layout.list_item, products, id, act);
