...
public class Perekus extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_perekus);
        ...
        userList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                AlertDialog.Builder builder = new AlertDialog.Builder(Perekus.this);
                builder.setTitle("Важное сообщение!")
                        ...
                        .setPositiveButton("Да, удалить", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                db.delete("TABLE_PEREKUS", "_id = ?", new String[]{String.valueOf(id)});
                            }
                        })
        ...
        Cursor w = db.rawQuery("select * from TABLE_PEREKUS",null);
                ...
                while (Set == true) {
                    try {
                        runOnUiThread(new Runnable() {
                            ...
                            @Override
                            public void run() {
                                Cursor c = db.rawQuery("select * from TABLE_PEREKUS",null);
                                if(kol != c.getCount()){
                                    Spisochek();
                                    setKol(c.getCount());
                                }
    ...
    public void Spisochek(){
        ...
        userCursor =  db.rawQuery("Select * from TABLE_PEREKUS where data = date('now','localtime') AND per_user = " + id, null);
        // определяем, какие столбцы из курсора будут выводиться в ListView
        String[] headers = new String[] {DatabaseHelper.COLUMN_NAME_PROD,DatabaseHelper.COLUMN_KKAL};
        // создаем адаптер, передаем в него курсор
        userAdapter = new SimpleCursorAdapter(Perekus.this, android.R.layout.two_line_list_item,
    ...
    public void onMyButtonClick(View view)
    {
        ...
        RequestQueue requestQueue =  Volley.newRequestQueue(Perekus.this);
        Perekus.Listener listener = new Perekus.Listener();
    ...
    class Listener implements ResponseListener {
        ...
        ProductAdapter adapter = new ProductAdapter( Perekus.this, R.layout.list_item, products, id, act);
